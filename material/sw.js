...
var workbox_expiration_version = __webpack_require__(5);
...
// EXTERNAL MODULE: ./node_modules/workbox-background-sync/_version.js
var workbox_background_sync_version = __webpack_require__(6);

// CONCATENATED MODULE: ./node_modules/workbox-background-sync/lib/QueueStore.js
/*
  Copyright 2018 Google LLC
...
const DB_VERSION = 3;
const QueueStore_DB_NAME = 'workbox-background-sync';
const QueueStore_OBJECT_STORE_NAME = 'requests';
...
class QueueStore_QueueStore {
    ...
    constructor(queueName) {
        ...
        this._db = new DBWrapper(QueueStore_DB_NAME, DB_VERSION, {
    ...
    async pushEntry(entry) {
        ...
        await this._db.add(QueueStore_OBJECT_STORE_NAME, entry);
    }
    /**
    ...
    async unshiftEntry(entry) {
        if (false) {}
        const [firstEntry] = await this._db.getAllMatching(QueueStore_OBJECT_STORE_NAME, {
            count: 1,
        });
        if (firstEntry) {
     ...
     */
    async getAll() {
        return await this._db.getAllMatching(QueueStore_OBJECT_STORE_NAME, {
            index: INDEXED_PROP,
    ...
    async deleteEntry(id) {
        await this._db.delete(QueueStore_OBJECT_STORE_NAME, id);
    }
    /**
    ...
    async _removeEntry({ direction }) {
        const [entry] = await this._db.getAllMatching(QueueStore_OBJECT_STORE_NAME, {
            direction,
            index: INDEXED_PROP,
            query: IDBKeyRange.only(this._queueName),
            count: 1,
    ...
    _upgradeDb(event) {
        ...
        if (event.oldVersion > 0 && event.oldVersion < DB_VERSION) {
            if (db.objectStoreNames.contains(QueueStore_OBJECT_STORE_NAME)) {
                db.deleteObjectStore(QueueStore_OBJECT_STORE_NAME);
            }
        }
        const objStore = db.createObjectStore(QueueStore_OBJECT_STORE_NAME, {
            autoIncrement: true,
            keyPath: 'id',
        });
...
// CONCATENATED MODULE: ./node_modules/workbox-background-sync/lib/StorableRequest.js
/*
  Copyright 2018 Google LLC
...
// CONCATENATED MODULE: ./node_modules/workbox-background-sync/Queue.js
/*
  Copyright 2018 Google LLC
...
class Queue_Queue {
    ...
    constructor(name, { onSync, maxRetentionTime } = {}) {
        ...
        if (queueNames.has(name)) {
            throw new WorkboxError_WorkboxError('duplicate-queue-name', { name });
        }
        else {
            queueNames.add(name);
        }
        ...
        this._queueStore = new QueueStore_QueueStore(this._name);
    ...
    async replayRequests() {
        ...
        while (entry = await this.shiftRequest()) {
            try {
                ...
                if (false) {}
                throw new WorkboxError_WorkboxError('queue-replay-failed', { name: this._name });
            }
        }
        if (false) {}
    }
...
// CONCATENATED MODULE: ./node_modules/workbox-background-sync/BackgroundSyncPlugin.js
/*
  Copyright 2018 Google LLC
 ...
 * @memberof module:workbox-background-sync
 */
class BackgroundSyncPlugin_BackgroundSyncPlugin {
    /**
    ...
    constructor(name, options) {
        ...
        this._queue = new Queue_Queue(name, options);
    }
}
...
// EXTERNAL MODULE: ./node_modules/workbox-google-analytics/_version.js
var workbox_google_analytics_version = __webpack_require__(8);

// CONCATENATED MODULE: ./node_modules/workbox-google-analytics/utils/constants.js
/*
  Copyright 2018 Google LLC
...
const constants_MAX_RETENTION_TIME = 60 * 48; // Two days in minutes
...
// CONCATENATED MODULE: ./node_modules/workbox-google-analytics/initialize.js
/*
  Copyright 2018 Google LLC
...
const createCollectRoutes = (bgSyncPlugin) => {
    ...
    const handler = new NetworkOnly_NetworkOnly({
        plugins: [bgSyncPlugin],
    });
    return [
        new Route_Route(match, handler, 'GET'),
        new Route_Route(match, handler, 'POST'),
    ];
};
/**
...
const createAnalyticsJsRoute = (cacheName) => {
    ...
    const handler = new NetworkFirst_NetworkFirst({ cacheName });
    return new Route_Route(match, handler, 'GET');
};
/**
...
const initialize = (options = {}) => {
    ...
    const bgSyncPlugin = new BackgroundSyncPlugin_BackgroundSyncPlugin(QUEUE_NAME, {
        maxRetentionTime: constants_MAX_RETENTION_TIME,
...
// CONCATENATED MODULE: ./node_modules/workbox-google-analytics/index.js
/*
  Copyright 2018 Google LLC
...
// CONCATENATED MODULE: ./node_modules/workbox-google-analytics/index.mjs
...
var workbox_recipes_version = __webpack_require__(4);
...
function googleFontsCache(options = {}) {
    ...
    registerRoute(({ url }) => url.origin === 'https://fonts.googleapis.com', new StaleWhileRevalidate_StaleWhileRevalidate({
        cacheName: sheetCacheName,
    }));
    // Cache the underlying font files with a cache-first strategy for 1 year.
    registerRoute(({ url }) => url.origin === 'https://fonts.gstatic.com', new CacheFirst_CacheFirst({
...
function imageCache(options = {}) {
    ...
    plugins.push(new CacheableResponsePlugin_CacheableResponsePlugin({
        statuses: [0, 200],
    }));
    plugins.push(new ExpirationPlugin_ExpirationPlugin({
        maxEntries,
        maxAgeSeconds
    }));
    const strategy = new CacheFirst_CacheFirst({
        cacheName,
        plugins,
    });
...
function staticResourceCache(options = {}) {
    ...
    const strategy = new StaleWhileRevalidate_StaleWhileRevalidate({
        cacheName,
        plugins,
    });
    registerRoute(matchCallback, strategy);
...
function pageCache(options = {}) {
    ...
    const strategy = new NetworkFirst_NetworkFirst({
...
const navigationStrategy = new NetworkFirst_NetworkFirst({
  cacheName: "pages",
  plugins: [
    new CacheableResponsePlugin_CacheableResponsePlugin({
      statuses: [200]
